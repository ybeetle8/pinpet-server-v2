...
// const SERVER_URL = 'https://182.16.54.186';
...
function connectAndSubscribe(mint) {
    ...
    socket = io(`${SERVER_URL}/kline`, {
        ...
        // SSL 配置 - 跳过证书验证（用于自签名或 CloudFlare Origin 证书）
        // SSL Configuration - Skip certificate verification (for self-signed or CloudFlare Origin certificates)
        rejectUnauthorized: false,
        extraHeaders: {
